...
class OphNuPreoperativechecklistModule extends BaseEventTypeModule
{
	...
	public function init() {
		...
		$this->setImport(array(
			'OphNuPreoperativechecklist.models.*',
			'OphNuPreoperativechecklist.components.*',
		));
		
		$this->moduleShortSuffix = "preoperative";
	}
